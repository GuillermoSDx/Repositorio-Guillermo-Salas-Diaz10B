        ...
        const fetchData = async () => {
            try {
                ...
                if (storedToken && idUser) {
                    const response = await axios.get(`${apiConfig.baseURL}/api/v1/empleado/${idUser}`, {
                        headers: {
                    ...
                    if (responseData.success) {
                        ...
                        console.log(empleadoData.datos_emergencia.numero_seguro);
                        setUserData({
                            ...
                            horario: '',
                            nss: empleadoData.datos_seguro.numero_seguro // Aquí debes obtener el horario del usuario, ya sea de la API o de otro lugar
                        });
                    }
                }
            } catch (error) {
